...
// STUDENT_TEST("Test the maximum count of stack frames fit in the system's call stack") {
//     EXPECT_EQUAL(myPower(1, 30000), pow(1, 30000));	// no error
//     EXPECT_EQUAL(myPower(1, 40000), pow(1, 40000)); // SIGSEGV
// }
